// apps/super-admin/src/services/staff-accounts.service.ts

import { supabase } from '../lib/supabase'
import type { SuperAdminAccount, SuperAdminRole } from '../types/staff-accounts.types'
...
export async function toggleSuperAdminActive(id: string, isActive: boolean): Promise<void> {

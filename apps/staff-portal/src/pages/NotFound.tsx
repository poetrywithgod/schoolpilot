    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="text-sm font-medium text-gray-400 uppercase tracking-widest">Error 404</span>
          <div className="h-px w-12 bg-gray-300" />
        </div>
        ...
        <p className="text-gray-500 mb-2">
          Looks like this page bunked class and never showed up.
        </p>
        ...
        <p className="text-xs text-gray-300 mt-12">
          SchoolPilot · Even our 404 page shows up on time 😄
        </p>
      </div>
    </div>
  )

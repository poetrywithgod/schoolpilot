...
export const ParentDashboard = () => {
      ...
      try {
        ...
        const mapped = data.map((item: any) => ({
          ...
          classes: Array.isArray(item.classes)
            ? (item.classes[0] ?? null)
            : item.classes,
          school: Array.isArray(item.school)
            ? (item.school[0] ?? null)
            : item.school,
        }));
        setChildren(mapped);
  ...
  const goToChildPage = (
    path: "subjects" | "results" | "fees" | "announcements" | "attendance",
  ) => {
              ...
              <div className="flex gap-2 mb-4 overflow-x-auto pb-1">
                {children.map((child) => (
                  <button
                    ...
                    style={{
                      backgroundColor:
                        activeChild?.id === child.id ? "#0C3B2E" : "white",
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor:
                          activeChild?.id === child.id ? "#FFBA00" : "#e8f5f0",
                        color: "#0C3B2E",
                        fontFamily: "Poppins, sans-serif",
                      }}
                    >
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              {[
                ...
                },
                {
                  ...
                  color: "#2563eb",
                  bg: "#eff6ff",
                  action: () => goToChildPage("attendance"),
                },
                {
                  label: "Announcements",
                  icon: Megaphone,
                  color: "#b08800",
                  bg: "#fffbeb",
                  action: () => goToChildPage("announcements"),
                },
              ].map((item) => {
